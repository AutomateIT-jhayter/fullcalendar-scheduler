...
TimelineGrid = (function(superClass) {
  ...
  TimelineGrid.prototype.renderFgSegsInContainers = function(pairs) {
    var container, coords, doVerticals, j, k, l, len, len1, len2, len3, m, ref, ref1, seg, segs, view;
    view = this.view;
    ...
    doVerticals = (function(_this) {
      return function() {
        var len4, len5, len6, len7, n, p, q, r, ref2, ref3, results;
    ...
    if (FC.waitForVerticalsHack) {
      setTimeout(function() {
        ...
        return setTimeout(function() {
          return view.calendar.updateSize();
        }, 1000);
      }, 0);
    } else {
      doVerticals();
...
RowParent = (function() {
  ...
  RowParent.prototype.expand = function() {
    ...
    if (!this.isExpanded) {
      ...
      this.animateExpand();
      return FC.waitForVerticalsHack = false;
    }
  };
...
ResourceRow = (function(superClass) {
  ...
  function ResourceRow(view, resource1) {
    ...
    this.isExpanded = view.opt('resourcesInitiallyExpanded');
  }
